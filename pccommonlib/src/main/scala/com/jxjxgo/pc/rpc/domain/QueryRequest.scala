...
object QueryRequest extends ThriftStructCodec3[QueryRequest] {
  ...
  val OrderSubmitTimeField = new TField("orderSubmitTime", TType.I64, 5)
  ...
  def unapply(_item: QueryRequest): _root_.scala.Option[scala.Product10[Long, String, String, String, Long, String, String, String, String, String]] = _root_.scala.Some(_item)
  ...
  trait Proxy extends QueryRequest {
    ...
    override def memberId: Long = _underlying_QueryRequest.memberId
    override def paymentVoucherNo: String = _underlying_QueryRequest.paymentVoucherNo
    override def channelCode: String = _underlying_QueryRequest.channelCode
    override def amount: String = _underlying_QueryRequest.amount
    override def orderSubmitTime: Long = _underlying_QueryRequest.orderSubmitTime
    override def ext1: String = _underlying_QueryRequest.ext1
    override def ext2: String = _underlying_QueryRequest.ext2
    override def ext3: String = _underlying_QueryRequest.ext3
    override def ext4: String = _underlying_QueryRequest.ext4
    override def ext5: String = _underlying_QueryRequest.ext5
...
trait QueryRequest
  ...
  with scala.Product10[Long, String, String, String, Long, String, String, String, String, String]
  with java.io.Serializable
{
          ...
          _fieldId match {
            case 1 =>
              if (true) {
                ...
                _root_.scala.Some(QueryRequest.MemberIdField)
              } else {
                _root_.scala.None
              }
            case 2 =>
              if (paymentVoucherNo ne null) {
                ...
                _root_.scala.Some(QueryRequest.PaymentVoucherNoField)
              } else {
                _root_.scala.None
              }
            case 3 =>
              if (channelCode ne null) {
                ...
                _root_.scala.Some(QueryRequest.ChannelCodeField)
              } else {
                _root_.scala.None
              }
            case 4 =>
              if (amount ne null) {
                ...
                _root_.scala.Some(QueryRequest.AmountField)
              } else {
                _root_.scala.None
              }
            case 5 =>
              if (true) {
                ...
                _root_.scala.Some(QueryRequest.OrderSubmitTimeField)
              } else {
                _root_.scala.None
              }
            case 6 =>
              if (ext1 ne null) {
                ...
                _root_.scala.Some(QueryRequest.Ext1Field)
              } else {
                _root_.scala.None
              }
            case 7 =>
              if (ext2 ne null) {
                ...
                _root_.scala.Some(QueryRequest.Ext2Field)
              } else {
                _root_.scala.None
              }
            case 8 =>
              if (ext3 ne null) {
                ...
                _root_.scala.Some(QueryRequest.Ext3Field)
              } else {
                _root_.scala.None
              }
            case 9 =>
              if (ext4 ne null) {
                ...
                _root_.scala.Some(QueryRequest.Ext4Field)
              } else {
                _root_.scala.None
              }
            case 10 =>
              if (ext5 ne null) {
                ...
                _root_.scala.Some(QueryRequest.Ext5Field)
              } else {
                _root_.scala.None
              }
   ...
   * from the passthroughFields map, if present.
   */
  def unsetMemberId: QueryRequest = unsetField(1)

  def unsetPaymentVoucherNo: QueryRequest = unsetField(2)

  def unsetChannelCode: QueryRequest = unsetField(3)

  def unsetAmount: QueryRequest = unsetField(4)

  def unsetOrderSubmitTime: QueryRequest = unsetField(5)

  def unsetExt1: QueryRequest = unsetField(6)

  def unsetExt2: QueryRequest = unsetField(7)

  def unsetExt3: QueryRequest = unsetField(8)

  def unsetExt4: QueryRequest = unsetField(9)

  def unsetExt5: QueryRequest = unsetField(10)
