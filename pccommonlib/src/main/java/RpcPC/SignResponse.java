...
public class SignResponse extends PCBaseResponse
{
    public SignResponse()
    {
        super();
    ...
    public SignResponse(String code, String paymentVoucherNo, String channelCode, String apiResultCode, String ext1, String ext2, String ext3, String ext4, String ext5)
    {
        super(code);
    ...
    clone()
    {
        return (SignResponse)super.clone();
    }

    public static final long serialVersionUID = 8627654975199587365L;
}
